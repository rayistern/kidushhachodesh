...
export default {
  ...
  sections: [
    {
      ...
      body: [
        ...
        'The Rambam calls that height the **latitude** — the *rochav* (רוחב), literally "width". It never gets larger than **five degrees** either way.',
...

    {
      ...
      body: [
        ...
        'The Rambam names them for what the moon does there. At one, the moon is crossing from below the sun\'s track to above it — that is the **head** (ראש). Half a circle away, it is crossing back down — the **tail** (זנב).',
        'At either point the moon sits exactly on the sun\'s track and has no height at all. Between them it climbs to five degrees and comes back down. So if you know where the head is, and where the moon is, you know how high it must be — which is the calculation the rest of the chapter performs.',
...

    {
      ...
      body: [
        ...
        'The head does not stay put, and it does not travel the way everything else does. It moves **against** the order of the signs — the Rambam says it goes "from Dagim to D\'li", which is backwards through the list. Everything else in the book counts forwards.',
        ...
        'That backwards march is why KH 16:3 gives an instruction that otherwise makes no sense. You work out the head\'s progress exactly as you did the sun\'s and the moon\'s — count the days, add up the chunks, add the starting figure — and then you **subtract the whole thing from 360**. Everything else you calculate, you use as it stands. This one you flip.',
        'The flip is simply what "backwards" means in arithmetic. Your running total counts how far the head has gone; because it goes the other way, that distance has to be taken off a full circle to give a position.',
      ],
...

    {
      ...
      body: [
        ...
        'The course here is the moon\'s true position less the head\'s position, and it is called the **course of the latitude**. It says how far past the crossing point the moon has travelled.',
        'Which side it is on falls straight out of that one number. Under 180 degrees and the moon is still in the half of its circle that lies above the sun\'s track — **northerly**. Over 180 and it is in the half below — **southerly**. Exactly 180 or 360, and it is sitting on the crossing point with no height at all.',
      ],
    },

    {
      ...
      body: [
        ...
        'The reason is that height behaves differently from the corrections you have met. Those rose once and fell once across the circle. Height rises and falls **twice** — up to five north, back to nothing at the tail, down to five south, back to nothing at the head. Two humps need two folds each.',
      ],
...

    {
      ...
      body: [
        ...
        'The moon\'s true position he already has from chapter 15. The head he works out here. Subtract one from the other for the course of the latitude, drop the minutes, fold it into the table, and read off the height.',
        'His answer: **3 degrees and 53 minutes, southerly**. The moon that evening sat nearly four degrees *below* the sun\'s track.',
        'Which is not good news for seeing it. Below the track means lower in the sky at sunset than it would otherwise have been, and lower means deeper in the glare. Chapter 17 is where that finally gets weighed.',
      ],
  ...
  closing: {
    have: [
      ...
      'The position of the head and tail on any date, remembering that the head runs backwards.',
