...
export default {
  ...
  terms: [
    {
      plain: 'the gap',
      formal: 'the elongation, later the first longitude',
      hebrew: null,
      gloss:
        "How far the moon has pulled away from the sun since they were last together — measured **along** the sun's own path. The big part of the moon's distance from the sun, and not what this chapter is about. Chapter 15 used it; chapter 17 will call it the first longitude.",
    },
    {
  ...
  sections: [
...

    {
      ...
      body: [
        ...
        'Think of the sun as travelling along a road across the sky. Most of the moon\'s distance from the sun is **along that road** — the moon is simply further down it, in the direction the sun has come from.',
        'That distance along the road is **the gap between the sun and the moon**: how far the moon has pulled away from the sun since the two of them were last in the same place. It is the same quantity chapter 15 subtracted to get its doubled figure, and the one chapter 17 will call the *first longitude*. Three names, one measurement.',
        'And it is the big one. On the night in question it runs to twenty or thirty degrees — hold your arm out and that is one to one and a half spread hands, or two to three fists. Plenty to see. It is essentially the whole of what you notice when you look up at a new moon.',
        'The rest — never more than five degrees — is the moon sitting a little **off the edge of the road**, to one side of it. Five degrees is about three fingers held at arm\'s length: small next to the gap, but ten times the width of the moon itself. That is what this chapter measures. North means one verge, south the other.',
        'So what you see is right about the big part: the moon really is mostly just *further along the road* from the sun. This chapter is only about the small sideways part sitting on top of that.',
        'And here is why "above" is a slippery word for it. **The sun\'s road is not level.** It cuts across the sky at an angle, and the angle changes through the year — steep on some evenings, shallow on others. So being off the north verge of the road translates into a mixture of higher and sideways, in a mix that changes with the season.',
