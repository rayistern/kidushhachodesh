  ...
  sections: [
...

    {
      ...
      body: [
        ...
        'The sun\'s circle is off-centre from us, so there is one point on it where the sun is **furthest away**. That point has a name, the **govah** (גובה), and its position at the epoch was 26° 45\' 8" in the 3rd sign (Teomim).',
        ...
        'And it moves. Very slowly: about one degree in seventy years, which is the slowest thing in the entire book. Over the eight and a half centuries since he wrote it has crept about thirteen degrees, out of the 3rd sign and into the 4th — a drift he himself anticipated.',
      ],
