  ...
  sections: [
...

    {
      ...
      body: [
        ...
        'Why double? Because the effect being corrected treats **new moon and full moon alike** — both are lineups of sun, earth and moon — and likewise treats the two quarter-moons alike. The gap on its own cannot say that: 0° and 180° are different numbers, and so are 90° and 270°. Doubling collapses each pair onto one. Twice 0 is 0, and twice 180 is 360, which is the same place on a circle; twice 90 and twice 270 both land on 180. So one short table serves both halves of the month.',
        'The nudge itself starts at nothing and grows: at the moment of lineup it is zero, and by the time the gap has opened to about thirty degrees it has reached its tabulated maximum of nine. He only tabulates the doubled gap up to 63°, because hunting a new crescent never needs more than that.',
