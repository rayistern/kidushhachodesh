  ...
  sections: [
...

    {
      ...
      body: [
        ...
        'Why double? Picture a pencil lying on a table. Turn it half way round and it looks exactly the same — a pencil has two ends and they are interchangeable. So a single number describing how that pencil lies has to give the **same answer** for 10 degrees and for 190. Doubling does that by itself: twice 10 is 20, and twice 190 is 380, which is 20 once you take off a full turn.',
        'The sun and the earth make a line like that pencil. The sun squeezes the moon\'s path according to the **line**, and it makes no difference which end the sun is sitting at. So the number the correction is looked up by has to treat both ends alike — and doubling the gap is what does it. Not a shortcut: it is the quantity the effect genuinely depends on.',
        'In practice you only ever meet the first stretch of it. On a night when a crescent might be caught, the doubled gap runs from a few degrees up to about sixty, and his table stops at 63° — it covers the whole range a sighting can produce and nothing beyond. The nudge starts at nothing when sun and moon are together and grows to nine degrees across that span. (He gives no reason for any of this; the account above is offered here.)',
