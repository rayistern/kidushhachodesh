  ...
  sections: [
...

    {
      ...
      body: [
        ...
        'Why double? There are two answers, and the practical one is smaller than you would expect. **It keeps the table in whole numbers.** His bands run 0–5, 6–11, 12–18 and so on in doubled degrees; halve them and half of those boundaries turn into 2½, 5½, 9½, 12½. For a reader adding by hand, with no decimal point available, whole numbers are worth having.',
        'The deeper answer is about where the quantity comes from, and it is worth a picture. Think of a pencil lying on a table: turn it half way round and it looks exactly the same, because a pencil has two ends and they are interchangeable. So a single number describing how that pencil lies must give the **same answer** for 10 degrees and for 190 — and doubling does that by itself, since twice 10 is 20 and twice 190 is 380, which is 20 once you take off a full turn.',
        'The sun and earth make a line like that pencil. The sun squeezes the moon\'s path according to the **line**, not according to which end the sun sits at — so in the general theory of the moon\'s motion, the doubled gap is genuinely the quantity the effect depends on.',
        'But be clear that this is not why it matters *here*. On the narrow range a sighting uses, the doubling never reaches the far side of the pencil at all: the gap runs from about 2½ degrees to 31, mapping straight onto 5 to 62, in step the whole way. It carries no extra information. He is keeping the variable the wider theory is written in, and taking the whole-number boundaries as a bonus. (None of this reasoning is his; he simply says to double it.)',
