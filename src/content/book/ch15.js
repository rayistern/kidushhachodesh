  ...
  sections: [
...

    {
      ...
      body: [
        ...
        'Why double? Not to save table space — the doubled gap is the quantity the effect actually depends on. **The sun distorts the moon\'s path according to the line it lies along, not which end of that line it is at.** Move the sun to the opposite side and the distortion is the same. Anything that repeats after half a turn like that is naturally measured by twice the angle — the same reason there are two high tides a day rather than one.',
