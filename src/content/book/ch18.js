  ...
  sections: [
...

    {
      ...
      body: [
        ...
        'Be clear about that division, because a sunset time printed under a chapter reference looks like his and is not. **Nothing in these nineteen chapters computes a sunset.** The instruction is his; the latitude is his; the sunset time on the card is a modern calculation, and so is the timezone and the daylight-saving rule.',
        'Which raises the question of how he managed without one — and the answer is the neatest thing in this section. The one place his method responds to sunset at all is **the season correction of chapter 14**: the nudge of nothing, or a quarter of a degree, or half a degree, applied to the moon\'s average place according to where the sun is. Sunset slides through the year, so by the time it arrives the moon has travelled further in summer than in winter, and he absorbs that as **arcminutes of moon motion instead of as a time**. No clock is ever needed. That correction is already inside the verdict, which is why the verdict needs no help from the section you are reading. (Reading his table as a sunset proxy is this book\'s interpretation, though. He gives no reason for it.)',
