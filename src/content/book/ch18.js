  ...
  sections: [
...

    {
      ...
      body: [
        ...
        'The card flags a night that falls **close to the line**, and carries two honest limits: his sun runs a hair fast, tilting marginal nights very slightly toward "visible"; and the verdict never consults a modern moon, so it cannot tell you when the moon sets. It tells you when and where to look.',
      ],
