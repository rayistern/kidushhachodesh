...
export default {
  ...
  sections: [
...

    {
      ...
      'And the reason different stretches meet the horizon differently is worth spelling out, because it is one fact and not a list. **The sun\'s road is a tilted ring.** Being a ring, it has a highest point and a lowest one — and chapter 19 puts numbers on them: the road runs up to 23½ degrees north of the equator at the start of the 4th sign (Sartan), and 23½ degrees south at the start of the 10th (G\'di).',
      'So travel along the belt in order and you are always doing one of two things: **climbing** toward the high point, or **falling** toward the low one. From the 10th sign forward through the 1st to the 4th, the road is climbing north. From the 4th forward through the 7th to the 10th, it is falling south. That is the whole of it — and it is why a stretch of the belt leans one way or the other as it goes down in the west.',
      'Now look at where the Rambam splits his two sets of thresholds in chapter 17. One set for the 10th sign through the 3rd; the other for the 4th through the 9th. Those are **exactly** the climbing half and the falling half, divided at the two turning points. He never explains the split, and the tables simply have two columns. This is what the two columns are.',
